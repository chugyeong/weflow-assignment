...
const titleClass = "mb-[34px] mx-auto max-w-[820px] text-center";
const headingClass = "text-[clamp(26px,3vw,38px)] font-black leading-[1.2] text-we-white";
const descClass = "mt-3 break-keep leading-[1.8] text-we-gray-500";
