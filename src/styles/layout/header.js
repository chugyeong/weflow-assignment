...
export const Inner = tw(
  "div",
  "relative z-[1] mx-auto flex h-[76px] max-w-[1200px] items-center justify-between px-5",
);

export const Logo = tw(
  Link,
  "flex items-center gap-2.5 text-2xl font-black tracking-[0] text-we-white [&_img]:w-11 [&_img]:object-contain [&_span]:bg-[linear-gradient(90deg,#fff,#58e6ff)] [&_span]:bg-clip-text [&_span]:text-transparent",
);

export const Nav = tw(
  "nav",
  "flex items-center gap-1 rounded-full border border-white/10 bg-white/[0.035] p-1 [&_a]:relative [&_a]:rounded-full [&_a]:px-4 [&_a]:py-2 [&_a]:text-sm [&_a]:font-semibold [&_a]:text-we-gray-300 [&_a]:transition-all [&_a:hover]:bg-white/8 [&_a:hover]:text-we-white [&_a.active]:bg-we-blue-300 [&_a.active]:text-white [&_a.active]:shadow-[0_10px_26px_rgba(37,99,235,0.28)] max-[900px]:absolute max-[900px]:left-4 max-[900px]:right-4 max-[900px]:top-[76px] max-[900px]:w-auto max-[900px]:flex-col max-[900px]:items-stretch max-[900px]:gap-1 max-[900px]:overflow-hidden max-[900px]:rounded-[14px] max-[900px]:border-white/10 max-[900px]:bg-we-black/95 max-[900px]:p-2 max-[900px]:shadow-we-black max-[900px]:backdrop-blur-xl max-[900px]:transition-all",
  ({ $isOpen }) =>
    $isOpen
...
export const MobileMenuButton = tw(
  "button",
  "hidden text-we-gray-100 max-[900px]:flex max-[900px]:h-11 max-[900px]:w-11 max-[900px]:items-center max-[900px]:justify-center max-[900px]:rounded-full max-[900px]:border max-[900px]:border-white/10 max-[900px]:bg-white/5 max-[900px]:transition-colors max-[900px]:hover:border-we-blue-300 max-[900px]:hover:text-we-blue-100",
);
